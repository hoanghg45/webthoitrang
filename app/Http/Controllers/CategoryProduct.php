...
class CategoryProduct extends Controller
{
    ...
    public function del_category($category_id)
    {
        ...
        $id_cate_product = ModelsProduct::pluck('category_id')->all();
        $check = ModelsCategory::whereNotIn('category_id', $id_cate_product)->first();
        if (!$check) {
            ...
            Session::put('message', 'Loại sản phẩm còn sản phẩm cùng loại!');
            return Redirect::to('all-category');
        }
    }
}
