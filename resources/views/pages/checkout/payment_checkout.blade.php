...
<head>
    <link rel="shortcut icon" href="//theme.hstatic.net/1000300454/1000793883/14/favicon.png?v=36" type="image/png" />
    <title>
        3H STORE- Thanh toán đơn hàng
    </title>

    <meta name="description" content="3H STORE- Thanh to&#225;n đơn h&#224;ng" />
    ...
    <link href='//theme.hstatic.net/1000300454/1000793883/14/check_out.css?v=36' rel='stylesheet' type='text/css'
        media='all' />
    ...
    <script type='text/javascript'>
        ...
        var meta = {
            "page": {
                ...
                "resourceId": "baacbf3193e64aaf807de2ba37f10379"
            },
            "cart": {
                "products": [{
                    "variantId": 1057895947,
                    "productId": 1026221540,
                    "price": 15000000.0,
                    "name": "Áo Thun Nam Y2010 Basic Z02 - Đen / M",
                    "sku": "AO668",
                    "vendor": "Khác",
                    "variant": "Đen / M",
                    "type": "Khác",
    ...
    <button class="order-summary-toggle order-summary-toggle-hide">
        <div class="wrap">
            <div class="order-summary-toggle-inner">
                ...
                <div class="order-summary-toggle-total-recap" data-checkout-payment-due-target="30000000">
                    <span class="total-recap-final-price">300,000₫</span>
                </div>
            </div>
        </div>
    </button>
                            ...
                            <div class="order-summary-section order-summary-section-product-list"
                                ...
                                <table class="product-table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="product" data-product-id="1026221540"
                                            data-variant-id="1057895947">
                                            ...
                                            <td class="product-description">
                                                ...
                                                <span class="product-description-variant order-summary-small-text">
                                                    {{ $cart['product_size'] }} |{{ $cart['product_price'] }}đ
                                                </span>

                                            </td>
                                            <td class="product-quantity visually-hidden">{{ $cart['product_quantity'] }}</td>
                                            <td class="product-price">
                                                <span class="order-summary-emphasis">{{ number_format($subtotal) }}đ</span>
                                            </td>
                                        </tr>
                                        @endforeach
                                        ...
                                        <tr class="total-line total-line-subtotal">
                                            ...
                                            <td class="total-line-price">
                                                <span class="order-summary-emphasis"
                                                    data-checkout-subtotal-price-target="30000000">
                                        ...
                                        <tr class="total-line">
                                            ...
                                            <td class="total-line-name payment-due">
                                                ...
                                                <span class="payment-due-price"
                                                    data-checkout-payment-due-target="30000000">
                                                    {{ number_format($total+40000) }}đ
                                                </span>
                                                <span class="checkout_version" display:none data_checkout_version="8">
                                                </span>
                                            </td>
                                        </tr>
                                    </tfoot>
        ...
        <div class="main-content">
            ...
            <div>
                ...
                <div class="step-footer">
                    ...
                    <a href="{{url('/homepage')}}" class="step-footer-continue-btn btn">
                    ...
                    <p class="step-footer-info">
                        ...
                        <span>
                            ...
                            Cần hỗ trợ? <a href="mailto:hoanghgggg@gmail.com">Liên hệ chúng tôi</a>
                        </span>
                    </p>
                </div>
            </div>
