...
<html lang="en" dir="ltr">
  ...
  <link href="{{asset('public/backend/plugins/flag-icons/css/flag-icon.min.css')}}" rel="stylesheet"/>
  ...
  <!-- SLEEK CSS -->
  <link id="sleek-css" rel="stylesheet" href="{{asset('public/backend/css/sleek.css')}}" />

  

  <!-- FAVICON -->
  <link href="{{asset('public/backend/img/favicon.png')}}" rel="shortcut icon" />
                      ...
                      <div class="sub-menu">
                        ...
                        <li  class="has-sub" >
                          <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse" data-target="#components"
                            ...
                            <span class="nav-text">Quản lý loại sản phẩm</span> <b class="caret"></b>
                          </a>
                          <ul  class="collapse"  id="components">
                            <div class="sub-menu">
                              
                              <li >
                                <a href="{{URL::to('/all-category')}}">Liệt kê danh sách</a>
                              </li>
                              
                              <li >
                                <a href="{{URL::to('/add-category')}}">Thêm</a>
                              </li>
                        ...
                        <li  class="has-sub" >
                          <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse" data-target="#icons"
                            ...
                            <span class="nav-text">Quản lý sản phẩm</span> <b class="caret"></b>
                          </a>
                          <ul  class="collapse"  id="icons">
                            <div class="sub-menu">
                              
                              <li >
                                <a href="{{URL::to('/all-product')}}">Liệt kê danh sách</a>
                              </li>
                              
                              <li >
                                <a href="{{URL::to('/add-product')}}">Thêm</a>
                              </li>
                ...
                <ul class="nav navbar-nav">
                  ...
                  <li class="dropdown user-menu">
                    <button href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                      <img src="{{asset('public/backend/img/user/admin.png')}}" class="user-image" alt="User Image" />
                    ...
                    <ul class="dropdown-menu dropdown-menu-right">
                      ...
                      <li class="dropdown-header">
                        <img src="{{asset('public/backend/img/user/admin.png')}}" class="img-circle" alt="User Image" />
                        <div class="d-inline-block">
                          @php
                           if ($admin_name && $admin_email) {
                            # code...
                            echo $admin_name.'<small class="pt-1">'.$admin_email.'</small>';
                          }
                          @endphp
                      ...
                      <li class="dropdown-footer">
                        <a href="{{URL::to('/logout')}}"> <i class="mdi mdi-logout"></i> Log Out </a>
                      </li>
                    </ul>
                  </li>
                </ul>
...
<script src="{{asset('public/backend/plugins/slimscrollbar/jquery.slimscroll.min.js')}}"></script>
<script src="{{asset('public/backend/plugins/charts/Chart.min.js')}}"></script>
...
<script src="{{asset('public/backend/plugins/jquery-mask-input/jquery.mask.min.js')}}"></script>
...
<script src="{{asset('public/backend/plugins/jekyll-search.min.js')}}"></script>
<script src="{{asset('public/backend/js/sleek.js')}}"></script>
<script src="{{asset('public/backend/js/chart.js')}}"></script>
<script src="{{asset('public/backend/js/date-range.js')}}"></script>
